...
export class SetupWizardService {
  ...
  getNewSeasonWizard() {
    return {
      ...
      description: 'Set up a new season for your rice mill with opening balances from the previous season',
      poweredBy: 'Asad Ali 0308-4420406',
      steps: [
        {
          step: 1,
          key: 'close_previous_season',
          title: 'Close Previous Fiscal Year',
          description: 'Close the previous fiscal year to lock all transactions and generate closing entries. Revenue and expense accounts will be closed to Retained Earnings.',
          isRequired: false,
          endpoint: 'POST /accounting-engine/close-fiscal-year/:fiscalYearId',
          helpText: 'Skip this step if this is your first season or you want to keep the previous year open.',
        },
        {
          step: 2,
          key: 'create_fiscal_year',
          title: 'Create New Fiscal Year',
          description: 'Create a new fiscal year for the upcoming season (e.g., July 2025 - June 2026).',
          isRequired: true,
          endpoint: 'POST /finance/fiscal-years',
        ...
        },
        {
          ...
          isRequired: true,
          endpoint: 'POST /csv-import/opening-balances',
          acceptsCsv: true,
          sampleColumns: ['account_code', 'debit', 'credit'],
          helpText: 'You can export the closing Trial Balance from your previous system (Tally, Excel) and upload it as CSV.',
        },
        {
          step: 4,
          ...
          isRequired: false,
          endpoint: 'POST /csv-import/customers',
          acceptsCsv: true,
        ...
        },
        {
          ...
          isRequired: false,
          endpoint: 'POST /csv-import/suppliers',
          acceptsCsv: true,
          sampleColumns: ['name', 'phone', 'email', 'address', 'opening_balance'],
        ...
        },
        {
          ...
          description: 'Set opening debit/credit balances for each customer and supplier as of season start.',
          isRequired: false,
          endpoint: 'POST /csv-import/party-balances',
          acceptsCsv: true,
        ...
        },
        {
          ...
          isRequired: true,
          endpoint: 'GET /accounting-engine/verify-trial-balance',
        ...
        },
        {
          ...
          description: 'Run all data integrity checks to ensure the system is ready for the new season.',
          isRequired: false,
          endpoint: 'GET /accounting-engine/integrity-checks',
          helpText: 'This checks for unbalanced journal entries, orphaned records, and other data issues.',
        },
      ],
    };
  }
